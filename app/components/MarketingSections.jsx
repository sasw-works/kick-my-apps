  ...
  return (
    <div className="mkt-root">
      <style>{`
        ...
        .mkt-grid-dark-inner {
          max-width: 1375px; margin-left: auto; margin-right: 0; overflow-x: auto;
