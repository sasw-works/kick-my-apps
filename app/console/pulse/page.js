  ...
  return (
    <main className="pulse-page">
      <style>{`
        ...
        .pulse-card {
          background: var(--surface); border: 1px solid var(--ink-3); border-radius: 8px; padding: 24px 24px;
          display: flex; align-items: center; gap: 16px;
        }
        .pulse-card-paused { opacity: 0.55; }
        .pulse-avatar {
          width: 42px; height: 42px; border-radius: 8px; color: #fff; font-weight: 700; font-size: 16px;
        ...
        .pulse-sentiment { display: flex; align-items: center; gap: 4px; font-size: 14px; font-weight: 600; min-width: 60px; justify-content: center; }
