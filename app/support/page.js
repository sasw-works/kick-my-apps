...
export default function SupportPage() {
  ...
  return (
    <main className="support-page">
      <style>{`
        .support-page { position: relative; max-width: 910px; margin: 0 auto; padding: 96px 24px 120px; font-family: var(--font-inter), sans-serif; }
        .support-bg-wrap {
          position: absolute;
          top: -100px;
          left: 50%;
        ...
        .support-blob { position: absolute; border-radius: 50%; filter: blur(90px); opacity: 0.45; pointer-events: none; }
        ...
        .support-faq-a { font-size: 14px; color: var(--muted); line-height: 1.6; padding: 0 4px 24px; }

        .support-contact {
          text-align: center; background: var(--ink-2); border: 1px solid var(--ink-3); border-radius: 8px; padding: 48px;
        }
        .support-contact-title { font-size: 20px; font-weight: 500; color: var(--chalk); margin-bottom: 8px; }
        .support-contact-sub { font-size: 16px; color: var(--muted); margin-bottom: 24px; }
        .support-contact-btn {
      ...
      {theme === "light" && (
        <div className="support-bg-wrap" aria-hidden="true">
          <div className="support-blob support-blob-1" />
          <div className="support-blob support-blob-2" />
          <div className="support-blob support-blob-3" />
          <div className="support-blob support-blob-4" />
          <div className="support-blob support-blob-5" />
        </div>
      )}
