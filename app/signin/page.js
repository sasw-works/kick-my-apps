...
export default function SignInPage() {
  ...
  const c = light
    ? { bg: "#F6F8FA", card: "#FFFFFF", border: "#E3E8EF", input: "#F6F8FA", title: "#1A2B3B", sub: "#697386", divider: "#E3E8EF" }
    : { bg: "#1e1e1e", card: "#17181F", border: "#2A2C36", input: "#22232C", title: "#FFFFFF", sub: "#A1A1AA", divider: "#2A2C36" };
  ...
  return (
    <main className="signin-page">
      <style>{`
        ...
        .signin-card { width: 100%; max-width: 440px; display: flex; flex-direction: column; align-items: center; }
        .signin-logo { margin-bottom: 32px; }
        .signin-title { margin: 0; font-size: 30px; font-weight: 700; color: ${c.title}; text-align: center; }
        .signin-sub { margin: 10px 0 32px; font-size: 15px; color: ${c.sub}; text-align: center; }
        .signin-google {
          ...
          font-size: 15px; font-weight: 600; color: ${c.title}; cursor: pointer;
          transition: background 0.15s ease;
        }
        .signin-google:hover { background: ${light ? "#F6F8FA" : "#1f2029"}; }
        .signin-divider { display: flex; align-items: center; gap: 16px; width: 100%; margin: 24px 0; }
        .signin-divider::before, .signin-divider::after { content: ""; flex: 1; height: 1px; background: ${c.divider}; }
        .signin-divider span { font-size: 12px; font-weight: 600; letter-spacing: 0.04em; color: ${c.sub}; }
        ...
        .signin-input {
          ...
          font-size: 15px; color: ${c.title}; font-family: inherit;
        }
        .signin-input::placeholder { color: ${c.sub}; }
        .signin-input:focus { outline: none; border-color: var(--blue-100); }
        .signin-code-input { text-align: center; font-size: 22px; letter-spacing: 0.3em; font-weight: 600; }
        .signin-submit {
          width: 100%; height: 52px; margin-top: 16px; display: flex; align-items: center; justify-content: center; gap: 8px;
          background: ${light ? "#111827" : "#FFFFFF"}; color: ${light ? "#FFFFFF" : "#111827"};
          border: none; border-radius: 999px; font-size: 15px; font-weight: 700; cursor: pointer;
        }
        .signin-submit:disabled { opacity: 0.6; cursor: default; }
        .signin-foot { margin-top: 24px; font-size: 13px; color: ${c.sub}; text-align: center; line-height: 1.6; }
        .signin-foot a { color: var(--blue-100); font-weight: 600; text-decoration: none; cursor: pointer; }
        .signin-error { width: 100%; margin-top: 12px; padding: 10px 14px; border-radius: 10px; background: color-mix(in srgb, var(--kick) 12%, transparent); color: var(--kick); font-size: 13px; }
      ...
      <div className="signin-card">
        <div className="signin-logo">
          <LogoMark size={48} color={c.title} />
        </div>
        ...
        {step === "email" ? (
          <>
            ...
            <button type="button" className="signin-google" onClick={() => signIn("google", { callbackUrl: "/console" })}>
              <GoogleGlyph />
            ...
            <p className="signin-foot">
              ...
              <br />
              Don&apos;t have an account? <a onClick={() => {}}>Join free</a>
            </p>
          </>
        ) : (
          <>
