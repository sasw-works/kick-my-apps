...
function AppStoreDataIcon({ size = 36 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M46 83.5C66.7107 83.5 83.5 66.7107 83.5 46C83.5 25.2893 66.7107 8.5 46 8.5C25.2893 8.5 8.5 25.2893 8.5 46C8.5 66.7107 25.2893 83.5 46 83.5Z" fill="white" />
      <path d="M81.139 59.125C75.8188 73.3624 62.0932 83.5 46 83.5C29.9067 83.5 16.1812 73.3624 10.861 59.125H81.139Z" fill="#D7E0FF" />
      <path d="M65.5161 35.0861C66.1159 34.2488 65.9235 33.0838 65.0861 32.4839C64.2488 31.8841 63.0838 32.0765 62.4839 32.9139L64 34L65.5161 35.0861ZM44.4839 58.0389C43.8841 58.8762 44.0765 60.0412 44.9139 60.6411C45.7512 61.2409 46.9162 61.0485 47.5161 60.2112L46 59.125L44.4839 58.0389ZM81.139 59.125L82.886 59.7778C83.1 59.2052 83.0198 58.5641 82.6713 58.0618C82.3228 57.5596 81.7503 57.26 81.139 57.26V59.125ZM10.861 59.125V57.26C10.2497 57.26 9.67717 57.5596 9.32868 58.0618C8.9802 58.5641 8.89997 59.2052 9.11395 59.7778L10.861 59.125ZM83.5 46H81.635C81.635 65.6807 65.6807 81.635 46 81.635V83.5V85.365C67.7407 85.365 85.365 67.7407 85.365 46H83.5ZM46 83.5V81.635C26.3193 81.635 10.365 65.6807 10.365 46H8.5H6.635C6.635 67.7407 24.2593 85.365 46 85.365V83.5ZM8.5 46H10.365C10.365 26.3193 26.3193 10.365 46 10.365V8.5V6.635C24.2593 6.635 6.635 24.2593 6.635 46H8.5ZM46 8.5V10.365C65.6807 10.365 81.635 26.3193 81.635 46H83.5H85.365C85.365 24.2593 67.7407 6.635 46 6.635V8.5ZM64 34L62.4839 32.9139L44.4839 58.0389L46 59.125L47.5161 60.2112L65.5161 35.0861L64 34ZM81.139 59.125L79.392 58.4722C74.3353 72.0044 61.2899 81.635 46 81.635V83.5V85.365C62.8965 85.365 77.3023 74.7204 82.886 59.7778L81.139 59.125ZM46 83.5V81.635C30.71 81.635 17.6647 72.0044 12.608 58.4722L10.861 59.125L9.11395 59.7778C14.6977 74.7204 29.1034 85.365 46 85.365V83.5ZM10.861 59.125V60.99H81.139V59.125V57.26H10.861V59.125Z" fill="#4147D5" />
    </svg>
  );
}
...
function FreshIcon({ size = 36 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M47.865 31.074C47.865 30.044 47.03 29.209 46 29.209C44.97 29.209 44.135 30.044 44.135 31.074H46H47.865ZM46 46.074H44.135C44.135 46.5686 44.3315 47.043 44.6812 47.3927L46 46.074ZM53.6812 56.3927C54.4096 57.1211 55.5904 57.1211 56.3188 56.3927C57.0471 55.6644 57.0471 54.4835 56.3188 53.7552L55 55.074L53.6812 56.3927ZM83.5 46H81.635C81.635 65.6807 65.6807 81.635 46 81.635V83.5V85.365C67.7407 85.365 85.365 67.7407 85.365 46H83.5ZM46 83.5V81.635C26.3193 81.635 10.365 65.6807 10.365 46H8.5H6.635C6.635 67.7407 24.2593 85.365 46 85.365V83.5ZM8.5 46H10.365C10.365 26.3193 26.3193 10.365 46 10.365V8.5V6.635C24.2593 6.635 6.635 24.2593 6.635 46H8.5ZM46 8.5V10.365C65.6807 10.365 81.635 26.3193 81.635 46H83.5H85.365C85.365 24.2593 67.7407 6.635 46 6.635V8.5ZM46 31.074H44.135V46.074H46H47.865V31.074H46ZM46 46.074L44.6812 47.3927L53.6812 56.3927L55 55.074L56.3188 53.7552L47.3188 44.7552L46 46.074Z" fill="#4147D5" />
    </svg>
  );
}
  ...
  return (
    <div className="mkt-root">
      <style>{`
        ...
        .mkt-feature-card-blue {
          background: linear-gradient(135deg, #EAF1FF, #DCE7FF);
          border: none; padding: 36px; display: flex; flex-direction: column; min-height: 320px;
        }
        .mkt-feature-card-blue .mkt-feature-title { font-size: 26px; font-weight: 800; color: #14213D; margin-bottom: 12px; }
        .mkt-feature-card-blue .mkt-feature-desc { font-size: 15px; color: #40507A; margin-bottom: 28px; }
        .mkt-feature-mockup {
          background: #FFFFFF; border-radius: 16px; padding: 20px;
          box-shadow: 0 8px 24px rgba(20,33,61,0.08); margin-top: auto;
        }
        .mkt-feature-card {
      ...
      <div>
        ...
        <div className="mkt-grid-4">
          <div className="mkt-feature-card mkt-feature-card-blue">
            ...
            <div className="mkt-feature-mockup">
