  ...
  return (
    <div className="mkt-root">
      <style>{`
        ...
        .mkt-grid-dark-inner {
          max-width: 1625px; margin-left: auto; margin-right: 0; overflow-x: auto;
        }
        .mkt-grid-dark-row {
        ...
        .mkt-grid-dark-spacer-md { flex-basis: 325px; }
        .mkt-grid-dark-spacer-sm { flex-basis: 0px; }
        .mkt-grid-dark-cell {
          position: relative; overflow: hidden; flex: 0 0 325px; width: 325px; height: 275px;
