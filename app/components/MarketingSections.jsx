  ...
  return (
    <div className="mkt-root">
      <style>{`
        ...
        .mkt-grid-dark-inner {
          max-width: 1635px; margin-left: auto; margin-right: 0; overflow-x: auto;
        }
        .mkt-grid-dark-row {
        ...
        .mkt-grid-dark-topline { position: absolute; top: 0; left: 0; width: 1308px; height: 1px; background: rgba(255,255,255,0.12); }
        .mkt-grid-dark-row-2 { position: relative; border-top: none; }
        .mkt-grid-dark-topline-left { position: absolute; top: 0; left: 327px; right: 0; height: 1px; background: rgba(255,255,255,0.12); }
        .mkt-grid-dark-title {
          flex: 0 0 654px;
        ...
        .mkt-grid-dark-spacer-md { flex-basis: 327px; }
        .mkt-grid-dark-spacer-sm { flex-basis: 0px; }
        .mkt-grid-dark-cell {
          position: relative; overflow: hidden; flex: 0 0 327px; width: 327px; height: 275px;
        ...
        @media (max-width: 1300px) {
          .mkt-grid-dark-row { flex-wrap: wrap; overflow-x: auto; }
